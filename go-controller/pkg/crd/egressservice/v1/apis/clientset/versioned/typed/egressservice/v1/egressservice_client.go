...
import (
	...
	scheme "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/egressservice/v1/apis/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type K8sV1Interface interface {
	RESTClient() rest.Interface
	EgressServicesGetter
}
...
func (c *K8sV1Client) EgressServices(namespace string) EgressServiceInterface {
	return newEgressServices(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := egressservicev1.SchemeGroupVersion
