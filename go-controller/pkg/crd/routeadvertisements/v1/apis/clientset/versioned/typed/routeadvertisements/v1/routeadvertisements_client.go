...
func (c *K8sV1Client) RouteAdvertisements() RouteAdvertisementsInterface {
	return newRouteAdvertisements(c)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := routeadvertisementsv1.SchemeGroupVersion
