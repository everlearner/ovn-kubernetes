...
type K8sV1Interface interface {
	...
	AdminPolicyBasedExternalRoutesGetter
}
...
func (c *K8sV1Client) AdminPolicyBasedExternalRoutes() AdminPolicyBasedExternalRouteInterface {
	return newAdminPolicyBasedExternalRoutes(c)
}
