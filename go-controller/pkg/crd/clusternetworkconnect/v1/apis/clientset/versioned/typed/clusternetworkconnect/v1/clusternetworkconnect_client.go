...
func (c *K8sV1Client) ClusterNetworkConnects() ClusterNetworkConnectInterface {
	return newClusterNetworkConnects(c)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := clusternetworkconnectv1.SchemeGroupVersion
