...
// apply.
func EVPNConfig() *EVPNConfigApplyConfiguration {
	return &EVPNConfigApplyConfiguration{}
}
...
func (b *EVPNConfigApplyConfiguration) WithVTEP(value string) *EVPNConfigApplyConfiguration {
	b.VTEP = &value
	return b
}
